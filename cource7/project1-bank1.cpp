...
enum emainmenue {show =1 , add =2, del=3, update=4, finduser=5, finish=6};
...
sclient readclient() {  
    ...
    while(clientexist(client.accountnumber, vclient)) { 
        ...
        cout << "\n\nclient exist please enter another account: ";
        getline(cin >> ws, client.accountnumber); 
    }
