...
void printclients(clientdata data) {

    cout << "|" << left << setw(10) << data.acountnum;
    cout << "|" << left << setw(10) << data.pincode;
    cout << "|" << left << setw(30) << data.name;
    cout << "|" << left << setw(20) << data.phone;
    cout << "|" << left << setw(20) << data.acountbalance;
}

void printallclientrecord(vector<clientdata> vclient) {

    cout << "\t\t\t\t\t" << "Clients list (" << vclient.size() << ") Client(s).\n";
    cout << "----------------------------------------------------------------------------------------------------\n";
    cout << "|" << left << setw(10) << "acountnum";
    cout << "|" << left << setw(10) << "pincode";
    cout << "|" << left << setw(30) << "name";
    cout << "|" << left << setw(20) << "phone";
    cout << "|" << left << setw(20) << "acountbalance";
    cout << "\n----------------------------------------------------------------------------------------------------\n";
